...
pub async fn get_video_stream(configuration: &configuration::Configuration, item_id: &str, container: Option<&str>, r#static: Option<bool>, params: Option<&str>, tag: Option<&str>, device_profile_id: Option<&str>, play_session_id: Option<&str>, segment_container: Option<&str>, segment_length: Option<i32>, min_segments: Option<i32>, media_source_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, allow_video_stream_copy: Option<bool>, allow_audio_stream_copy: Option<bool>, break_on_non_key_frames: Option<bool>, audio_sample_rate: Option<i32>, max_audio_bit_depth: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<crate::models::SubtitleDeliveryMethod>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, require_avc: Option<bool>, de_interlace: Option<bool>, require_non_anamorphic: Option<bool>, transcoding_max_audio_channels: Option<i32>, cpu_core_limit: Option<i32>, live_stream_id: Option<&str>, enable_mpegts_m2_ts_mode: Option<bool>, video_codec: Option<&str>, subtitle_codec: Option<&str>, transcode_reasons: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>, context: Option<crate::models::EncodingContext>, stream_options: Option<::std::collections::HashMap<String, String>>) -> Result<std::path::PathBuf, Error<GetVideoStreamError>> {
    let local_var_configuration = configuration;
...
pub async fn get_video_stream_by_container(configuration: &configuration::Configuration, item_id: &str, container: &str, r#static: Option<bool>, params: Option<&str>, tag: Option<&str>, device_profile_id: Option<&str>, play_session_id: Option<&str>, segment_container: Option<&str>, segment_length: Option<i32>, min_segments: Option<i32>, media_source_id: Option<&str>, device_id: Option<&str>, audio_codec: Option<&str>, enable_auto_stream_copy: Option<bool>, allow_video_stream_copy: Option<bool>, allow_audio_stream_copy: Option<bool>, break_on_non_key_frames: Option<bool>, audio_sample_rate: Option<i32>, max_audio_bit_depth: Option<i32>, audio_bit_rate: Option<i32>, audio_channels: Option<i32>, max_audio_channels: Option<i32>, profile: Option<&str>, level: Option<&str>, framerate: Option<f32>, max_framerate: Option<f32>, copy_timestamps: Option<bool>, start_time_ticks: Option<i64>, width: Option<i32>, height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, video_bit_rate: Option<i32>, subtitle_stream_index: Option<i32>, subtitle_method: Option<crate::models::SubtitleDeliveryMethod>, max_ref_frames: Option<i32>, max_video_bit_depth: Option<i32>, require_avc: Option<bool>, de_interlace: Option<bool>, require_non_anamorphic: Option<bool>, transcoding_max_audio_channels: Option<i32>, cpu_core_limit: Option<i32>, live_stream_id: Option<&str>, enable_mpegts_m2_ts_mode: Option<bool>, video_codec: Option<&str>, subtitle_codec: Option<&str>, transcode_reasons: Option<&str>, audio_stream_index: Option<i32>, video_stream_index: Option<i32>, context: Option<crate::models::EncodingContext>, stream_options: Option<::std::collections::HashMap<String, String>>) -> Result<std::path::PathBuf, Error<GetVideoStreamByContainerError>> {
    let local_var_configuration = configuration;
