...
pub async fn update_configuration(configuration: &configuration::Configuration, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<UpdateConfigurationError>> {
    let local_var_configuration = configuration;
...
pub async fn update_media_encoder_path(configuration: &configuration::Configuration, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<UpdateMediaEncoderPathError>> {
    let local_var_configuration = configuration;
