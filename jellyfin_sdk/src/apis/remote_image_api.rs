...
pub async fn download_remote_image(configuration: &configuration::Configuration, item_id: &str, r#type: crate::models::ImageType, image_url: Option<&str>) -> Result<(), Error<DownloadRemoteImageError>> {
...
pub async fn get_remote_images(configuration: &configuration::Configuration, item_id: &str, r#type: Option<crate::models::ImageType>, start_index: Option<i32>, limit: Option<i32>, provider_name: Option<&str>, include_all_languages: Option<bool>) -> Result<crate::models::RemoteImageResult, Error<GetRemoteImagesError>> {
    let local_var_configuration = configuration;
