...
pub async fn update_item(configuration: &configuration::Configuration, item_id: &str, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<UpdateItemError>> {
    let local_var_configuration = configuration;
