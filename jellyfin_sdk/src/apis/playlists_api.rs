...
pub async fn add_to_playlist(configuration: &configuration::Configuration, playlist_id: &str, ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>) -> Result<(), Error<AddToPlaylistError>> {
...
pub async fn create_playlist(configuration: &configuration::Configuration, name: Option<&str>, ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, media_type: Option<&str>, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<crate::models::PlaylistCreationResult, Error<CreatePlaylistError>> {
    let local_var_configuration = configuration;
