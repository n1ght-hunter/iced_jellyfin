...
pub async fn get_similar_albums(configuration: &configuration::Configuration, item_id: &str, exclude_artist_ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, limit: Option<i32>, fields: Option<Vec<crate::models::ItemFields>>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarAlbumsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_artists(configuration: &configuration::Configuration, item_id: &str, exclude_artist_ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, limit: Option<i32>, fields: Option<Vec<crate::models::ItemFields>>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarArtistsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_items(configuration: &configuration::Configuration, item_id: &str, exclude_artist_ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, limit: Option<i32>, fields: Option<Vec<crate::models::ItemFields>>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarItemsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_movies(configuration: &configuration::Configuration, item_id: &str, exclude_artist_ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, limit: Option<i32>, fields: Option<Vec<crate::models::ItemFields>>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarMoviesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_shows(configuration: &configuration::Configuration, item_id: &str, exclude_artist_ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, limit: Option<i32>, fields: Option<Vec<crate::models::ItemFields>>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarShowsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_similar_trailers(configuration: &configuration::Configuration, item_id: &str, exclude_artist_ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, limit: Option<i32>, fields: Option<Vec<crate::models::ItemFields>>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSimilarTrailersError>> {
    let local_var_configuration = configuration;
...
pub async fn post_updated_media(configuration: &configuration::Configuration, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<PostUpdatedMediaError>> {
    let local_var_configuration = configuration;
