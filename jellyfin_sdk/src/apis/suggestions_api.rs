...
pub async fn get_suggestions(configuration: &configuration::Configuration, user_id: &str, media_type: Option<Vec<String>>, r#type: Option<Vec<crate::models::BaseItemKind>>, start_index: Option<i32>, limit: Option<i32>, enable_total_record_count: Option<bool>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetSuggestionsError>> {
