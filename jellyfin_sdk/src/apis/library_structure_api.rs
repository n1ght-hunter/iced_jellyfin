...
pub async fn add_media_path(configuration: &configuration::Configuration, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE, refresh_library: Option<bool>) -> Result<(), Error<AddMediaPathError>> {
...
pub async fn add_virtual_folder(configuration: &configuration::Configuration, name: Option<&str>, collection_type: Option<crate::models::CollectionTypeOptions>, paths: Option<Vec<String>>, refresh_library: Option<bool>, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<AddVirtualFolderError>> {
    let local_var_configuration = configuration;
...
pub async fn update_library_options(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<UpdateLibraryOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_media_path(configuration: &configuration::Configuration, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<UpdateMediaPathError>> {
    let local_var_configuration = configuration;
