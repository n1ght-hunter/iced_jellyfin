...
pub async fn add_listing_provider(configuration: &configuration::Configuration, pw: Option<&str>, validate_listings: Option<bool>, validate_login: Option<bool>, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<crate::models::ListingsProviderInfo, Error<AddListingProviderError>> {
...
pub async fn add_tuner_host(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<crate::models::TunerHostInfo, Error<AddTunerHostError>> {
    let local_var_configuration = configuration;
...
pub async fn create_series_timer(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<CreateSeriesTimerError>> {
    let local_var_configuration = configuration;
...
pub async fn create_timer(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<CreateTimerError>> {
    let local_var_configuration = configuration;
...
pub async fn get_lineups(configuration: &configuration::Configuration, id: Option<&str>, r#type: Option<&str>, location: Option<&str>, country: Option<&str>) -> Result<Vec<crate::models::NameIdPair>, Error<GetLineupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_live_tv_programs(configuration: &configuration::Configuration, channel_ids: Option<Vec<uuid::Uuid>>, user_id: Option<&str>, min_start_date: Option<String>, has_aired: Option<bool>, is_airing: Option<bool>, max_start_date: Option<String>, min_end_date: Option<String>, max_end_date: Option<String>, is_movie: Option<bool>, is_series: Option<bool>, is_news: Option<bool>, is_kids: Option<bool>, is_sports: Option<bool>, start_index: Option<i32>, limit: Option<i32>, sort_by: Option<Vec<String>>, sort_order: Option<Vec<crate::models::SortOrder>>, genres: Option<Vec<String>>, genre_ids: Option<Vec<uuid::Uuid>>, enable_images: Option<bool>, image_type_limit: Option<i32>, enable_image_types: Option<Vec<crate::models::ImageType>>, enable_user_data: Option<bool>, series_timer_id: Option<&str>, library_series_id: Option<&str>, fields: Option<Vec<crate::models::ItemFields>>, enable_total_record_count: Option<bool>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetLiveTvProgramsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_programs(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetProgramsError>> {
    let local_var_configuration = configuration;
...
pub async fn set_channel_mapping(configuration: &configuration::Configuration, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<crate::models::TunerChannelMapping, Error<SetChannelMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_series_timer(configuration: &configuration::Configuration, timer_id: &str, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<UpdateSeriesTimerError>> {
    let local_var_configuration = configuration;
...
pub async fn update_timer(configuration: &configuration::Configuration, timer_id: &str, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<UpdateTimerError>> {
    let local_var_configuration = configuration;
