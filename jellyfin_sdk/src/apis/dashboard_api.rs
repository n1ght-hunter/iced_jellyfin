...
pub async fn get_configuration_pages(configuration: &configuration::Configuration, enable_in_main_menu: Option<bool>) -> Result<Vec<crate::models::ConfigurationPageInfo>, Error<GetConfigurationPagesError>> {
...
pub async fn get_dashboard_configuration_page(configuration: &configuration::Configuration, name: Option<&str>) -> Result<std::path::PathBuf, Error<GetDashboardConfigurationPageError>> {
    let local_var_configuration = configuration;
