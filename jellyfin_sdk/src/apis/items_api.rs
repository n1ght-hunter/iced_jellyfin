...
pub async fn get_items_by_user_id(configuration: &configuration::Configuration, user_id: &str, max_official_rating: Option<&str>, has_theme_song: Option<bool>, has_theme_video: Option<bool>, has_subtitles: Option<bool>, has_special_feature: Option<bool>, has_trailer: Option<bool>, adjacent_to: Option<&str>, parent_index_number: Option<i32>, has_parental_rating: Option<bool>, is_hd: Option<bool>, is4_k: Option<bool>, location_types: Option<Vec<crate::models::LocationType>>, exclude_location_types: Option<Vec<crate::models::LocationType>>, is_missing: Option<bool>, is_unaired: Option<bool>, min_community_rating: Option<f64>, min_critic_rating: Option<f64>, min_premiere_date: Option<String>, min_date_last_saved: Option<String>, min_date_last_saved_for_user: Option<String>, max_premiere_date: Option<String>, has_overview: Option<bool>, has_imdb_id: Option<bool>, has_tmdb_id: Option<bool>, has_tvdb_id: Option<bool>, is_movie: Option<bool>, is_series: Option<bool>, is_news: Option<bool>, is_kids: Option<bool>, is_sports: Option<bool>, exclude_item_ids: Option<Vec<uuid::Uuid>>, start_index: Option<i32>, limit: Option<i32>, recursive: Option<bool>, search_term: Option<&str>, sort_order: Option<Vec<crate::models::SortOrder>>, parent_id: Option<&str>, fields: Option<Vec<crate::models::ItemFields>>, exclude_item_types: Option<Vec<crate::models::BaseItemKind>>, include_item_types: Option<Vec<crate::models::BaseItemKind>>, filters: Option<Vec<crate::models::ItemFilter>>, is_favorite: Option<bool>, media_types: Option<Vec<String>>, image_types: Option<Vec<crate::models::ImageType>>, sort_by: Option<Vec<String>>, is_played: Option<bool>, genres: Option<Vec<String>>, official_ratings: Option<Vec<String>>, tags: Option<Vec<String>>, years: Option<Vec<i32>>, enable_user_data: Option<bool>, image_type_limit: Option<i32>, enable_image_types: Option<Vec<crate::models::ImageType>>, person: Option<&str>, person_ids: Option<Vec<uuid::Uuid>>, person_types: Option<Vec<String>>, studios: Option<Vec<String>>, artists: Option<Vec<String>>, exclude_artist_ids: Option<Vec<uuid::Uuid>>, artist_ids: Option<Vec<uuid::Uuid>>, album_artist_ids: Option<Vec<uuid::Uuid>>, contributing_artist_ids: Option<Vec<uuid::Uuid>>, albums: Option<Vec<String>>, album_ids: Option<Vec<uuid::Uuid>>, ids: Option<Vec<uuid::Uuid>>, video_types: Option<Vec<crate::models::VideoType>>, min_official_rating: Option<&str>, is_locked: Option<bool>, is_place_holder: Option<bool>, has_official_rating: Option<bool>, collapse_box_set_items: Option<bool>, min_width: Option<i32>, min_height: Option<i32>, max_width: Option<i32>, max_height: Option<i32>, is3_d: Option<bool>, series_status: Option<Vec<crate::models::SeriesStatus>>, name_starts_with_or_greater: Option<&str>, name_starts_with: Option<&str>, name_less_than: Option<&str>, studio_ids: Option<Vec<uuid::Uuid>>, genre_ids: Option<Vec<uuid::Uuid>>, enable_total_record_count: Option<bool>, enable_images: Option<bool>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetItemsByUserIdError>> {
    let local_var_configuration = configuration;
