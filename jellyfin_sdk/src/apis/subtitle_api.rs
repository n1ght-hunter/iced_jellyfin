...
pub async fn upload_subtitle(configuration: &configuration::Configuration, item_id: &str, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<UploadSubtitleError>> {
    let local_var_configuration = configuration;
