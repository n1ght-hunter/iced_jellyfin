...
pub async fn report_playback_progress(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<ReportPlaybackProgressError>> {
    let local_var_configuration = configuration;
...
pub async fn report_playback_start(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<ReportPlaybackStartError>> {
    let local_var_configuration = configuration;
...
pub async fn report_playback_stopped(configuration: &configuration::Configuration, unknown_base_type: Option<crate::models::UNKNOWN_BASE_TYPE>) -> Result<(), Error<ReportPlaybackStoppedError>> {
    let local_var_configuration = configuration;
