...
pub async fn play(configuration: &configuration::Configuration, session_id: &str, play_command: crate::models::PlayCommand, item_ids: Vec<uuid::Uuid>, start_position_ticks: Option<i64>, media_source_id: Option<&str>, audio_stream_index: Option<i32>, subtitle_stream_index: Option<i32>, start_index: Option<i32>) -> Result<(), Error<PlayError>> {
    let local_var_configuration = configuration;
...
pub async fn post_full_capabilities(configuration: &configuration::Configuration, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE, id: Option<&str>) -> Result<(), Error<PostFullCapabilitiesError>> {
    let local_var_configuration = configuration;
...
pub async fn send_full_general_command(configuration: &configuration::Configuration, session_id: &str, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<SendFullGeneralCommandError>> {
    let local_var_configuration = configuration;
...
pub async fn send_message_command(configuration: &configuration::Configuration, session_id: &str, unknown_base_type: crate::models::UNKNOWN_BASE_TYPE) -> Result<(), Error<SendMessageCommandError>> {
    let local_var_configuration = configuration;
