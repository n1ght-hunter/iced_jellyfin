...
pub async fn get_genre(configuration: &configuration::Configuration, genre_name: &str, user_id: Option<&str>) -> Result<crate::models::BaseItemDto, Error<GetGenreError>> {
...
pub async fn get_genres(configuration: &configuration::Configuration, start_index: Option<i32>, limit: Option<i32>, search_term: Option<&str>, parent_id: Option<&str>, fields: Option<Vec<crate::models::ItemFields>>, exclude_item_types: Option<Vec<crate::models::BaseItemKind>>, include_item_types: Option<Vec<crate::models::BaseItemKind>>, is_favorite: Option<bool>, image_type_limit: Option<i32>, enable_image_types: Option<Vec<crate::models::ImageType>>, user_id: Option<&str>, name_starts_with_or_greater: Option<&str>, name_starts_with: Option<&str>, name_less_than: Option<&str>, sort_by: Option<Vec<String>>, sort_order: Option<Vec<crate::models::SortOrder>>, enable_images: Option<bool>, enable_total_record_count: Option<bool>) -> Result<crate::models::BaseItemDtoQueryResult, Error<GetGenresError>> {
    let local_var_configuration = configuration;
