...
pub struct EncodingOptions {
    ...
    #[serde(rename = "TonemappingAlgorithm", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tonemapping_algorithm: Option<Option<String>>,
    #[serde(rename = "TonemappingMode", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tonemapping_mode: Option<Option<String>>,
    #[serde(rename = "TonemappingRange", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "DeinterlaceMethod", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
