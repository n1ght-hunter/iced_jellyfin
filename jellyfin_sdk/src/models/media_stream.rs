...
pub struct MediaStream {
    ...
    #[serde(rename = "VideoRange", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub video_range: Option<Option<String>>,
    /// Gets the video range type.
    #[serde(rename = "VideoRangeType", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
