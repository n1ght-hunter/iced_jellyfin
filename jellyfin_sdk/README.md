# Rust API client for jellyfin_sdk
...
Put the package under your project folder in a directory named `jellyfin_sdk` and add the following to `Cargo.toml` under `[dependencies]`:

```
jellyfin_sdk = { path = "./jellyfin_sdk" }
```
...
## Documentation For Models
 ...
 - [ClientCapabilitiesDtoDeviceProfile](docs/ClientCapabilitiesDtoDeviceProfile.md)
